...
To use a new technology either create a new technology from the technology manager :menuselection:`Tools --> Manage Technologies` or create a new package 
:menuselection:`Tools --> Manage Packages` for the technology.
...
The script can be found in :menuselection:`File --> Import Cadence Techfile`

After importing, the properties can be saved via :menuselection:`File --> Save Layer Properties`. Recommended location for the file is in the technology folder in `~/.klayout/tech/<technology-name>/<file>` or if using a package
